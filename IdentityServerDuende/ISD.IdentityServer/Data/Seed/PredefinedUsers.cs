using IdentityModel;
using ISD.IdentityServer.Application.Common.Models;
using ISD.IdentityServer.Application.Infrastructure;
using ISD.IdentityServer.Data.Models;
using System.Security.Claims;
using static ISD.IdentityServer.Data.Seed.PredefinedUsers;
...
internal static class PredefinedUsers
{
    internal static List<SeedUser> GetUsers(IEnvironmentSettings environment)
    {
        ...
        users.AddUser("user@isd.com", Role.User);
