...
namespace ISD.InvestTrackApplication.Commands;
...
internal class AuthorizeIdentityUserByCodeCommandHandler : IRequestHandler<AuthorizeIdentityUserByCodeCommand, UserInfo?>
{
    ...
    public AuthorizeIdentityUserByCodeCommandHandler(IHttpClientFactory httpClientFactory, IHttpContextAccessor contextAccessor)
    {
